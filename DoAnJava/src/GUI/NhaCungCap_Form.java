 ...
 * @author CHINH
 */
public class NhaCungCap_Form extends javax.swing.JFrame {
    ...
    public NhaCungCap_Form() {
        ...
        list=new NhaCungCapBUS().gestListNhaCungCap();
        model=(DefaultTableModel) jTable1.getModel();
        model.setColumnIdentifiers(new Object[]{
            "STT","Mã NCC","Tên NCC","DiaChi","SDT","Gmail"
        });
    ...
    public void showTable(){
        ...
        for (NhaCungCap s:list){
            model.addRow(new Object[]{
                i++,s.getMaNCC(),s.getTenNCC(),s.getDiaChi(),s.getSDT(),s.getGmail()
            });
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imaige/gmail.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imaige/nhacungcap1.png"))); // NOI18N
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txTenNCC, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        s.setTenNCC(txTenNCC.getText());
        s.setDiaChi(txDiaChi.getText());
        s.setSDT(txSDT.getText());
        s.setGmail(txGmail.getText());
        if (new NhaCungCapBUS().addNhaCungCap(s)){
    ...
    public void showDB(){
        ...
        txMaNCC.setText(jTable1.getValueAt(selectrow,1).toString());
        txTenNCC.setText(jTable1.getValueAt(selectrow,2).toString());
        txDiaChi.setText(jTable1.getValueAt(selectrow,3).toString());
        txSDT.setText(jTable1.getValueAt(selectrow,4).toString());
        txGmail.setText(jTable1.getValueAt(selectrow,5).toString());
    }
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        s.setSDT(txSDT.getText());
        s.setGmail(txGmail.getText());
        if (new NhaCungCapBUS().updateNhaCungCap(s)){
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        NhaCungCap s= new NhaCungCap();
        s.setMaNCC(txMaNCC.getText());
        if (new NhaCungCapBUS().deleteNhaCungCap(s)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NhaCungCap_Form.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NhaCungCap_Form().setVisible(true);
            }
        });
    }
